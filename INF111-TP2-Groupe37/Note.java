...
public class Note {	
    ...
    * TEST MEL
	 ...
	 */
	public void jouer(SourceDataLine line, double niveau, double sample) {
		...
		if (frequence_ == 0) {
         ...
         //JOUER AVEC LES FRÉQUENCES ET AVEC LES % dans le sample
         
         //FormeOnde forme1 = new FormeSinus(15, fe);
         FormeOnde forme1 = new FormeSinus(frequence_, fe);
         
			FormeOnde forme2 = new FormeTriangle(0.15555, fe);
         //FormeOnde forme2 = new FormeTriangle(frequence_, fe);
         ...
         FormeOnde forme3 = new FormeCarre(frequence_, fe);
            ...
            */
            ...
            /*
            // Calcul de la valeur de l'�chantillon dans [-1.0, 1.0].
				double sample = niveau * 
                    (3.3 * forme1.echantillon(i) 
						+ 0 * forme2.echantillon(i)
						+ 0 * forme3.echantillon(i)
						+ 0 * forme4.echantillon(i)
						);
            */
            ...
            // Calcul de la valeur de l'�chantillon dans [-1.0, 1.0].
				...
				sample = niveau * 
                    (3 * forme1.echantillon(i) 
						+ 2 * forme2.echantillon(i)
						+ 2 * forme3.echantillon(i)
						+ 0 * forme4.echantillon(i)
						);
