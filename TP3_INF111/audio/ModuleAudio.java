...
public class ModuleAudio {
   ...
   private final static int DIAPASON = 440;
   ...
   /**
    * Joue la note donnee en parametre. La note joue de maniere continue tant
    * qu'on ne joue pas un silence (voir methode jouerUnSilence).
    *
    * La note donnee doit respecter le format explique dans la classe
    * NotationUS. Exemples: - C#3 : do diese a l'octave 3 - F5 : fa a l'octave 5
    * - Eb4 : mi bemol a l'octave 4
    *
    ...
    * //http://www.wolinlabs.com/blog/java.sine.wave.html et adapte pour les
    * besoins du cours INF111.
    */
   private class ThreadEchantillons extends Thread {
      ...
      /**
       * Genere des echantilonns d'onde sinusoidale, sur NB_OCTETS octets, d'un
       * volume donne en parametre, et les place dans le buffer donne en
       * parametre.
       *
       ...
       * echantillon.
       * @return la position finale courante dans le cycle de l'onde
       * sinusoidale.
       */
      private double genererEchantillons(int volume,
         ...
         for (int i = 0; i < TAILLE_ECHANTILLON_SINE / TAILLE_ECHANTILLON; i++) {
            ...
            buffer.putShort((short) (volume * Math.sin(TAILLE_ECHANTILLON * Math.PI
      ...
      /**
       * Retourne le nombre d'echantillons enfiles dans le tampon de la ligne
       * audio.
       *
       * @return le nombre d'echantillons enfiles dans le tampon de la ligne
       * audio.
       */
       ...
       * TAUX_ECHANTILLONNAGE hz, des echantillons sur NB_BITS bits, et
       * l'ordonnancement des octets en "big endian".
       *
      ...
      private void ouvrirLigne() {
         try {
            ...
            DataLine.Info info = new DataLine.Info(SourceDataLine.class,
               formatAudio, TAILLE_ECHANTILLON_SINE * TAILLE_ECHANTILLON);
